  ...
  return (
    <div className='min-h-screen bg-gradient-to-b from-white via-[#F8F8F8] to-white text-gray-900'>
      ...
      <main className='max-w-4xl mx-auto py-16 px-6 text-center'>
        <h1 className='text-4xl font-bold mb-4 text-[#FF6B35]'>มุ้งจีบดีไซน์ชาญฉลาด</h1>
        <p className='text-lg text-gray-700 mb-8'>
          ป้องกันยุงและแมลง พร้อมรับลมธรรมชาติอย่างมีสไตล์ เหมาะกับบ้านสมัยใหม่และโครงการคุณภาพ
        </p>
        ...
        <div className='mt-12'>
          ...
          <ul className='text-gray-700 space-y-2 text-left max-w-md mx-auto'>
            <li>✅ ดีไซน์มินิมอล เข้ากับบ้านสมัยใหม่</li>
            <li>✅ ใช้งานลื่นมือ บานไม่ตก</li>
            <li>✅ อลูมิเนียมหนา สีอโนไดซ์</li>
            <li>✅ ถอดล้างง่าย ไม่ขึ้นสนิม</li>
          </ul>
        </div>
      </main>
